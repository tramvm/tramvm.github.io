    ...
    PROJECTS = [
        ...
        },
        {
            ...
            'description': '<p><strong>Unlimited usage for each order on a browser</strong>. Tampermonkey script, Greasemonkey script available for almost browsers. Features:</p>'
                           ...
                           '</ul>'
                           '<p>No need to install any additional software.</p>'
                           '<p>With above features, $19 for unlimited usage on 2 instance browsers, $89 for unlimited usage up to 10 browsers.</p>'
                           '<p>For Unlimited usage package $199. Up to 50 browsers. NO limit number of requests per day.</p>'
